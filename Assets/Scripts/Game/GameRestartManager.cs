...
namespace SnakeGame3D.Game
{
    ...
    /// Resets GameOverManager, GamePauseManager, ScoreManager, SnakeController, ArenaBoundary, SnakeSelfCollision, Food, FoodSpawner, GameOverUI, and PauseUI
    ...
    public class GameRestartManager : MonoBehaviour
    {
        ...
        /// 3. Resets ScoreManager (score back to 0)
        /// 4. Resets SnakeController (removes growth segments, resets position/direction/path, enables movement)
        /// 5. Resets ArenaBoundary state
        /// 6. Resets SnakeSelfCollision state
        /// 7. Resets Food and FoodSpawner state
        /// 8. Hides Game Over UI panel & updates Pause UI
        /// </summary>
